...
def parse_args():
    ...
    parser.add_argument('--classifier', default='Cosine', help='Ours, Cosine, ArcFace, CosFace')
    parser.add_argument('--scale_factor', type=int, default=10)
    parser.add_argument('--epsilon', type=float, default=(2 * math.pi / 3))
    ...
    parser.add_argument('--feature_dim', type=int, default=512,
                        help='3200 for Conv128, 1600 for Conv64, 384 for ResNet12, 512 for ResNet18')
    parser.add_argument('--num_class', type=int, default=64, help='100 for CUB, 64 for miniimagenet')

    parser.add_argument('--split', default='base', help='novel, val')

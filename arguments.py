...
def parse_args():
    ...
    parser.add_argument('--classifier', default='Ours', help='Ours, Cosine, ArcFace, CosFace')
    parser.add_argument('--scale_factor', type=int, default=30)
    parser.add_argument('--epsilon', type=float, default=(math.pi / 2))
    parser.add_argument('--margin', type=int, default=0.35)

    parser.add_argument('--num_epochs', type=int, default=-1)
    parser.add_argument('--base_batch_size', type=int, default=512)
